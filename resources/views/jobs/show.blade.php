...
<body>
    ...
    <?php
        $rawthumbnail = $job->video;
        $rawlink = "uploads/video";
        $video_link = $rawlink."/".$rawthumbnail;
        // echo  $video_link;

    ?> 
    <div class="v-play">
      <video width="100%" controls>
        <source src="{{URL::asset($video_link)}}" type="video/mp4">
      </video>
    </div>

    <div class="m-4">
    <div class="container-fluid">
        <section class="v-title">
            <h1 style="color:white;">  {{ $job->title }} </h1>
        </section>
    </div><br>

    <div class="container-fluid">
        <section class="v-desc" style="color:white;">
            <h3  disabled>Description</h3>
